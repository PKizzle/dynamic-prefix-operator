...
func dynamicPrefixDependentChangePredicate() predicate.Predicate {
	return predicate.Funcs{
		...
		// Services outlives the DynamicPrefix, and those addresses -- including an
		// external-dns target -- stop being routable at the next rotation, so the
		// dependents have to be told in order to hand them back.
